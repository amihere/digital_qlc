...
# Eli Configuration Documentation

## Overview

This configuration defines the conversational flow for Eli, a mental health support chatbot designed specifically for mothers experiencing various challenges in their parenting journey.

## Key Features

### Safety Protocol

- Built-in safety assessment (EPDS Question 10)
- Immediate crisis intervention routing
- Emergency contact information provision

### Specialized Paths

- **Pregnancy/Conception Support**: For mothers trying to conceive or currently pregnant
- **Loss Support**: For mothers who have experienced pregnancy or infant loss
- **Nursing Mother Support**: Three specialized paths for common nursing mother concerns
- **NICU Support**: Dedicated path for mothers with babies in NICU

### Assessment Tools

- **EPDS (Edinburgh Postnatal Depression Scale)**: 10-question standardized assessment
- **Grounding Exercises**: 5-4-3-2-1 method for anxiety management
- **Self-compassion Exercises**: Mindfulness-based comfort techniques

### Support Options

- Professional mental health referrals
- Community support group connections
- Self-care and rest validation

## Flow Structure

### Entry Point

- Warm greeting and name collection
- Privacy policy acknowledgment
- Basic demographic information (age, location, country)
- Mental health experience assessment

### Condition-Based Routing

Routes users based on their current parenting stage:

- Trying to conceive
- Currently pregnant
- Pregnancy/baby loss
- Nursing mother (primary focus)

### Nursing Mother Paths

Three specialized concern areas:

1. **Sadness/Disconnection**: Includes full EPDS screening
2. **NICU Stress**: Addresses specific NICU-related concerns
3. **General Stress/Anxiety**: Provides grounding techniques

### Exit Options

- Professional support referral with contact collection
- Community group enrollment
- Rest and self-care validation
- Feedback collection
...
- All personal information collection is marked as optional ("SKIP" option)
- Clear privacy policy references
- Minimal data collection approach
- Secure handling procedures outlined

### Crisis Management

- Immediate safety assessment for self-harm thoughts
- Crisis hotline provision (0800678678)
- Mandatory conversation termination for safety concerns
- No therapeutic advice beyond immediate safety

### Cultural Sensitivity

- Designed for mothers in Ghana, Nigeria, South Africa, Kenya, Jamaica, and USA
- Culturally appropriate language and examples
- Regional phone number format examples

## Implementation Guidelines

### Required Features

- Variable interpolation for personalization (`{name}`)
- Complex conditional routing based on responses
...
- Regional customization based on country selection
- Follow-up scheduling capabilities
- Multi-language support

### Quality Assurance

- Test all safety protocol triggers
- Verify crisis intervention pathways
- Validate contact collection processes
- Ensure graceful conversation endings
